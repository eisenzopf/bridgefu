...
SAFE_SOURCE_FAILURE_PREFIXES = (
    ...
    "immutable Vapi demo site rejected its configuration",
    "immutable Vapi demo site configuration was unavailable",
    "immutable Vapi demo site failed during initialization",
    "immutable Vapi demo site configuration load did not settle",
