...
variable "template_url" {
  description = "Immutable HTTPS URL for the signed Starter Production root template."
  type        = string
...
variable "parameters" {
  description = "Exact CloudFormation parameter map from the immutable release and customer inputs."
  type        = map(string)
  sensitive   = true
